        ...
        def action_create
          unless exists?
            begin
              ...
              options += " %s" @new_resource.createdb ? "CREATEDB" : "NOCREATEDB"
              options += " %s" @new_resource.createuser ? "CREATEUSER" : "NOCREATEUSER"
              options += " %s" @new_resource.login ? "LOGIN" : "NOLOGIN"
              options += " %s" @new_resource.replication ? "REPLICATION" : "NOREPLICATION"
              options += " %s" @new_resource.superuser ? "SUPERUSER" : "NOSUPERUSER"
